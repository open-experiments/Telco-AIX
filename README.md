<div align="center">
    <img src="https://raw.githubusercontent.com/open-experiments/Telco-AIX/main/images/logo3.png" width="321"/>
</div>
...
🌐 **Project site:** [open-experiments.github.io/Telco-AIX](https://open-experiments.github.io/Telco-AIX/) | 🔐 **Security policy:** [SECURITY.md](SECURITY.md)

## Experiments 

| Domain | Project | Focus Area |
|--------|---------|------------|
| 💰 Revenue Management | [RAFM](https://github.com/open-experiments/Telco-AIX/tree/main/revenueassurance) | Revenue Assurance & Fraud Detection |
| 📊 Service Quality | [Service Assurance](https://github.com/open-experiments/Telco-AIX/tree/main/serviceassurance) <br> [Churn Prediction](https://github.com/open-experiments/Telco-AIX/tree/main/churn)| Latency & NPS Predictions & Churn Predictions|
| 🌐 Network Operations | [5G Network Ops](https://github.com/open-experiments/Telco-AIX/tree/main/5gnetops) | Fault Predictions |
| 🌿 Sustainability | [Energy Efficiency](https://github.com/open-experiments/Telco-AIX/tree/main/sustainability) | Green Telecom Initiatives |
| 🔒 Security | [SecOps-AI](https://github.com/open-experiments/Telco-AIX/tree/main/secops) | Networking Security |
| ⚡ Smart Infrastructure | [AI Powered SmartGrid](https://github.com/open-experiments/Telco-AIX/tree/main/smartgrid) | Grid Optimization |
| 🛡️ IoT Security | [IoT Perimeter Security](https://github.com/open-experiments/Telco-AIX/tree/main/iot-sec) | Perimeter Security|
| 🚀 Advanced AI | [5G CNF RCA with LLM](https://github.com/ansonmez/5g_llm_ilab_demo) | Root Cause Analysis |
| 💬 Customer Experience | [CRM Voice App](https://github.com/open-experiments/Telco-AIX/tree/main/crm) <br> [Intent Classification](https://github.com/open-experiments/Telco-AIX/tree/main/intclass)| Intelligent Customer Interactions |
| 🔍 Anomaly Detection | [RootCause Analysis](https://github.com/open-experiments/Telco-AIX/tree/main/llm-rca) | Model Chaining & RAG |
...
- [Run DeepSeek Locally on Single K8s Node](https://github.com/open-experiments/Telco-AIX/tree/main/etc/deepseek)
...
|-------|----------|------|-------------|
| Distributed AI Inference Best Practices & Gotchas | Medium | [Read Article](https://medium.com/enterpriseai/distributed-ai-inference-best-practices-gotchas-911102c9a2ff) | Fatih E. Nar, Yuchen Fama, Greg Pereira, Yuan Tang |
| AI Provocateur | Medium | [Read Article](https://medium.com/enterpriseai/ai-provocateur-4b8e83f69935) | Matt Smith, Fatih E. Nar, Rimma Iontel, Paul Lancaster |
| The Busy Mom Syndrome | Medium | [Read Article](https://medium.com/enterpriseai/the-busy-mom-syndrome-e8a8829ae3db) | Fatih E. Nar, Robert Shaw, Taneem Ibrahim |
| The Best Choice for AI Inference: vLLM | Medium | [Read Article](https://medium.com/enterpriseai/episode-xxx-the-best-choice-for-ai-inference-vllm-286b2af2df71) | Fatih E. Nar, Greg Pereira, Yuan Tang, Robert Shaw et al. |
